...
- Treat your environment's instructions with HIGH priority — these rules supplement (not replace) them

**When using in Cursor:** See `.cursor/rules/model-compatibility.mdc` for prompt injection and tool details.
